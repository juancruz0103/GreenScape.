...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        usuarios.add(new Usuario("Jardinero", 2, "jardinero@gmail.com", "jardinpass", "jardinero"));
        ...
        if (usuarioLogueado != null) {
            ...
            JOptionPane.showMessageDialog(null, "Credenciales incorrectas. Intentarlo de nuevo.");
        }
    }
}
